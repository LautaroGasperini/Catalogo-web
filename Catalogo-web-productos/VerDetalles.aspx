...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card-detalles mb-3" style="max-width: 800px;">
        <div class="row g-0">
            <div class="col-md-4">
                <asp:Image ID="imgProducto" runat="server" CssClass="img-fluid rounded-start img-detalles" />
            </div>
            <div class=" card-text-detalles col-md-8">
                <div class="card-body">
                    <h5 class="card-title">
                    ...
                    <div class="d-flex justify-content-around">
                        <asp:Button Text="Volver" CssClass="btn btn-outline-light" ID="btnVolver" OnClick="btnVolver_Click" runat="server" />
                    </div>
                </div>
            </div>
        </div>
